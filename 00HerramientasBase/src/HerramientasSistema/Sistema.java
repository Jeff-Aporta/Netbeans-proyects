...
public class Sistema {
    ...
    public final static String ruta_jeffAporta_appdata = GenerarDirección_JeffAportaAppData();
    public final static String ruta_jeffAporta_tmp = GenerarDirección_JeffAportaTemp();

    static String[] links = tsv_google_spreadsheet.links();

    public final static String url_jeffAporta = tsv_google_spreadsheet.buscar(links, "Jeff Aporta");
    public final static String url_jeffDibuja = tsv_google_spreadsheet.buscar(links, "Jeff Dibuja");
    public final static String url_facebook = tsv_google_spreadsheet.buscar(links, "Facebook");
    public final static String url_donar_paypal = tsv_google_spreadsheet.buscar(links, "Paypal donación");

    public static void main(String[] args) {
        System.out.println(Verificar_Existencia_URL("http://www.forosdelweb.coma/f45/como-verificar-existencia-archivo-url-388808/"));
    }
