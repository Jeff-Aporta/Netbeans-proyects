...
public class ReproductorNotas {

    //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
    /**
     * <p align="center">
     * <img src="https://docs.google.com/drawings/d/e/2PACX-1vQj18MnJWyRhqzQM-tBI7paOFeAi5JhsMUvv7iYPEB4421d9tzVN9wQscfI-2mgESIYpDDnG0pC4oJZ/pub?w=357&h=452">
     * <p>
     */
    //</editor-fold>
    ...
    public static void main(String[] args) {
        ReproductorNotas notas = new ReproductorNotas();
    ...
    //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
    /**
     * Se encarga de cerrar la variable que reproduce los sonidos en el sistema.
     * <br><br>
     * Recomiendo que siempre se haga llamado a esta función cuando el objeto ya
     * no necesite ser usado para que el recolector de basura se encargue bien
     * de su eliminación.
     */
    //</editor-fold>
    public void Deponer() {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        CanalSonido = null;
        synth.close();
        synth2.close();
        synth = null;
    ...
    //<editor-fold defaultstate="collapsed" desc="Métodos para la reproducción »">
    //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
    /**
     * {@linkplain #Reproducir(int, java.lang.String) Reproduce una nota en el
     * <strong>canal 0</strong>
     * <br><br>
     * Ver la función de reproducción »}
     */
    //</editor-fold>
    public void Reproducir(String Nota) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        CanalSonido[0].noteOn(HerramientasMIDI.CalcularByte_Nota(Nota), (int) (Volúmen * 128));
    }//</editor-fold>

    //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
    /**
     * {@linkplain #Reproducir(int, java.lang.String, int, int) Reproduce una nota en el
     * <strong>canal 0</strong>, la sostiene por un tiempo dado en milisegundos
     * y genera una pausa también dada en milisegundos
     * <br><br>
     * Ver la función de reproducción »}
     */
    //</editor-fold>
    public void Reproducir(String Nota, int Sostener, int Pausa) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        Reproducir(0, Nota, Sostener, Pausa);
    }//</editor-fold>

    //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
    /**
     * Empieza la reproducción de una nota en el canal indicado. Es el
     * equivalente a presionar la tecla en el piano y dejarla presionada hasta
     * que se haga llamado a
     * {@linkplain #Suspender(int, java.lang.String)  Suspender en un canal especifíco}.
     * <p align="center">
     * <img src="https://docs.google.com/drawings/d/e/2PACX-1vSG5phmQ22fA2pjXtw341gPaug21lJGSRz9qj4O9sUhq9oOyaHNSHbeSFnjzA_DEkrhQIYCQawjdI3n/pub?w=100&h=100">
     * </p>
     * Toma una cadena de texto que será {@linkplain #CalcularByte_Nota(java.lang.String)
     * Calculada en un byte} representable de esa nota con la octava, de esta
     * manera la plataforma podrá reproducir el sonido correspondiente
     */
    //</editor-fold>
    public void Reproducir(int Canal, String Nota) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        CanalSonido[Canal].noteOn(HerramientasMIDI.CalcularByte_Nota(Nota), (int) (Volúmen * 128));
    }//</editor-fold>

    //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
    /**
     * Reproduce una nota en el canal indicado, la sostiene por un tiempo
     * especifíco en milisegundos y realiza una pausa (también especificada en
     * ms) entre esta nota y la siguiente a reproducir.
     * <br><p align="center">
     * <img src="https://docs.google.com/drawings/d/e/2PACX-1vSG5phmQ22fA2pjXtw341gPaug21lJGSRz9qj4O9sUhq9oOyaHNSHbeSFnjzA_DEkrhQIYCQawjdI3n/pub?w=100&h=100">
     * </p>
     * Toma una cadena de texto que será {@linkplain #CalcularByte_Nota(java.lang.String)
     ...
     * manera la plataforma podrá reproducir el sonido correspondiente
     * <br><br>
     * esta función genera una detención en el hilo de ejecución donde sea
     * llamada, por lo que recomiendo que este evento sea ejecutado dentro de un
     * hilo paralelo, es decir dentro de otro Thread.
     * <p align="center">
     * <img src = "https://docs.google.com/drawings/d/e/2PACX-1vQ5IYJXvHL7jpVkzSwAYmy264sB0YbItqnX8Ko1QqbA2d3V1OYMUmfQ5WXmmh0KD6Qnc582vTAHNTyg/pub?w=100&h=100">
     * </p>
     */
    //</editor-fold>
    public void Reproducir(int Canal, String Nota, int Sostener, int Pausa) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        new Thread() {
            @Override
            public void run() {
     ...
     */
    //</editor-fold>
    public void Reproducir(int Canal, int Nota, int Sostener, int Pausa) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        new Thread() {
            @Override
            public void run() {
                Reproducir(Canal, Nota);
    ...
    //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
    /**
     * {@linkplain #Reproducir(int, int)  Reproduce una nota en el
     * <strong>canal 0</strong>
     * <br><br>
     * Ver la función de reproducción »}
     */
    //</editor-fold>
    public void Reproducir(int byteNota) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
     ...
     * <img src="https://docs.google.com/drawings/d/e/2PACX-1vSG5phmQ22fA2pjXtw341gPaug21lJGSRz9qj4O9sUhq9oOyaHNSHbeSFnjzA_DEkrhQIYCQawjdI3n/pub?w=100&h=100">
     * </p>
     * Toma un {@linkplain #CalcularByte_Nota(java.lang.String)
     * byte representativo de la nota}, de esta manera la plataforma podrá
     * reproducir el sonido correspondiente
     */
    //</editor-fold>
    public void Reproducir(int Canal, int byteNota) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
     ...
     */
    //</editor-fold>
    public void Reproducir(int Canal, int byteNota, float volumen) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        CanalSonido[Canal].noteOn(byteNota, (int) (volumen * 128));
    }//</editor-fold>

    //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
    /**
     * Es lo mismo que Thread.sleep(ms); sirve para generar las pausas entre las
     * notas y reproducir una nota durante un tiempo definido.
     * <p align="center">
     * <img src = "https://docs.google.com/drawings/d/e/2PACX-1vQ5IYJXvHL7jpVkzSwAYmy264sB0YbItqnX8Ko1QqbA2d3V1OYMUmfQ5WXmmh0KD6Qnc582vTAHNTyg/pub?w=100&h=100">
     * </p>
     */
    //</editor-fold>
    private void Descansar(int Descanso) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        try {
    ...
    //<editor-fold defaultstate="collapsed" desc="Métodos para suspención »">
    byte ReguladorEco[] = new byte[12 * 11];

    //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
    /**
     * Detiene la reproducción de una nota en el <strong>canal 0</strong>. Es el
     * equivalente a dejar de presionar la tecla en el piano.
     * <p align="center">
     * <img src="https://docs.google.com/drawings/d/e/2PACX-1vQh9zZ8GK-VA4Ea-i5oFc3iKRHKDgX4XmNKjqWTu5Phx-klDSY5j72Ro6mptqzy2oPrnsKlp-womwIo/pub?w=100&h=100">
     * </p>
     */
    //</editor-fold>
    public void Suspender(String Nota) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        Suspender(0, HerramientasMIDI.CalcularByte_Nota(Nota));
    }//</editor-fold>

    //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
    /**
     * Detiene la reproducción de una nota en un canal indicado. Es el
     * equivalente a dejar de presionar la tecla en el piano.
     * <p align="center">
     * <img src="https://docs.google.com/drawings/d/e/2PACX-1vQh9zZ8GK-VA4Ea-i5oFc3iKRHKDgX4XmNKjqWTu5Phx-klDSY5j72Ro6mptqzy2oPrnsKlp-womwIo/pub?w=100&h=100">
     * </p>
     */
    //</editor-fold>
    public void Suspender(int Canal, String Nota) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        Suspender(Canal, HerramientasMIDI.CalcularByte_Nota(Nota));
    }//</editor-fold>
     ...
     */
    //</editor-fold>
    public void Suspender(int byteNota) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        Suspender(0, byteNota);
    }//</editor-fold>
     ...
     */
    //</editor-fold>
    public void Suspender(int Canal, int byteNota) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        new Thread() {
            @Override
            public void run() {
    ...
    //<editor-fold defaultstate="collapsed" desc="Métodos para cambiar de instrumento »">
    //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
    /**
     * {@linkplain #CambiarInstrumento(int, int) Cambia el instrumento del canal 0.
     * <br><br>
     * Ver la función para cambiar el instrumento »}
     */
    //</editor-fold>
    public void CambiarInstrumento(int Instrumento) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        CambiarInstrumento(0, Instrumento);
    }//</editor-fold>

    //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
    /**
     * Personaliza el instrumento en el canal ondicado.
     * <br><br>
     * el parámetro para el {@link HerramientasMIDI#12_STR_GT Instrumento} que
     * recibe no sigue ningún patrón en concreto, si se desea hacer una
     * selección siguiendo un patrón se puede seleccionar la opción de
     * {@linkplain #CambiarInstrumento(int, int, int) Cambiar el instrumento usando un banco y un programa}
     * que contiene la tabla con todos los bancos y programas soportados por la
     * plataforma.
     * <br><br>
     * Sin embargo los primeros 127 instrumentos si siguen un patrón y tienen
     * una categorización especial, acá les dejo la especificación de los rangos
     ...
     *104-111	Ethnic
     *112-119	Percussive
     *120-127	Sound Effects</pre>
     */
    //</editor-fold>
    public void CambiarInstrumento(int Canal, int Instrumento) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
    ...
    //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
    /**
     * Personaliza el instrumento en el <strong>canal 0</strong> con el que
     * deseamos reproducir las notas.
     * <br><br>
     * Afortunadamente esta plataforma cuenta con más de 220 instrumentos que
     * podemos usar para reproducir notas, acá les dejo una lista completa de
     * los instrumentos que soporta con su respectivo banco y programa.
     * <br><br>
     * <pre>
     *Instrument: Piano 1      bank #0 preset #0
     *Instrument: Piano 2      bank #0 preset #1
     *Instrument: Piano 3      bank #0 preset #2
     *Instrument: Honky-tonk   bank #0 preset #3
     *Instrument: E.Piano 1    bank #0 preset #4
     *Instrument: E.Piano 2    bank #0 preset #5
     *Instrument: Harpsichord  bank #0 preset #6
     *Instrument: Clav.        bank #0 preset #7
     ...
     *Instrument: Tubular-bell bank #0 preset #14
     *Instrument: Santur       bank #0 preset #15
     *Instrument: Organ 1      bank #0 preset #16
     *Instrument: Organ 2      bank #0 preset #17
     *Instrument: Organ 3      bank #0 preset #18
     *Instrument: Church Org.1 bank #0 preset #19
     *Instrument: Reed Organ   bank #0 preset #20
     *Instrument: Accordion Fr bank #0 preset #21
     *Instrument: Harmonica    bank #0 preset #22
     *Instrument: Bandoneon    bank #0 preset #23
     *Instrument: Nylon-str.Gt bank #0 preset #24
     *Instrument: Steel-str.Gt bank #0 preset #25
     *Instrument: Jazz Gt.     bank #0 preset #26
     *Instrument: Clean Gt.    bank #0 preset #27
     *Instrument: Muted Gt.    bank #0 preset #28
     *Instrument: Overdrive Gt bank #0 preset #29
     *Instrument: DistortionGt bank #0 preset #30
     *Instrument: Gt.Harmonics bank #0 preset #31
     *Instrument: Acoustic Bs. bank #0 preset #32
     *Instrument: Fingered Bs. bank #0 preset #33
     *Instrument: Picked Bs.   bank #0 preset #34
     *Instrument: Fretless Bs. bank #0 preset #35
     ...
     *Instrument: Tremolo Str  bank #0 preset #44
     *Instrument: PizzicatoStr bank #0 preset #45
     *Instrument: Harp         bank #0 preset #46
     *Instrument: Timpani      bank #0 preset #47
     *Instrument: Strings      bank #0 preset #48
     *Instrument: Slow Strings bank #0 preset #49
     *Instrument: Syn.Strings1 bank #0 preset #50
     *Instrument: Syn.Strings2 bank #0 preset #51
     *Instrument: Choir Aahs   bank #0 preset #52
     *Instrument: Voice Oohs   bank #0 preset #53
     *Instrument: SynVox       bank #0 preset #54
     *Instrument: OrchestraHit bank #0 preset #55
     *Instrument: Trumpet      bank #0 preset #56
     *Instrument: Trombone     bank #0 preset #57
     *Instrument: Tuba         bank #0 preset #58
     *Instrument: MutedTrumpet bank #0 preset #59
     *Instrument: French Horns bank #0 preset #60
     *Instrument: Brass 1      bank #0 preset #61
     *Instrument: Synth Brass1 bank #0 preset #62
     *Instrument: Synth Brass2 bank #0 preset #63
     ...
     *Instrument: Bottle Blow  bank #0 preset #76
     *Instrument: Shakuhachi   bank #0 preset #77
     *Instrument: Whistle      bank #0 preset #78
     *Instrument: Ocarina      bank #0 preset #79
     *Instrument: Square Wave  bank #0 preset #80
     *Instrument: Saw Wave     bank #0 preset #81
     *Instrument: Syn.Calliope bank #0 preset #82
     *Instrument: Chiffer Lead bank #0 preset #83
     *Instrument: Charang      bank #0 preset #84
     *Instrument: Solo Vox     bank #0 preset #85
     *Instrument: 5th Saw Wave bank #0 preset #86
     *Instrument: Bass & Lead  bank #0 preset #87
     *Instrument: Fantasia     bank #0 preset #88
     *Instrument: Warm Pad     bank #0 preset #89
     *Instrument: Polysynth    bank #0 preset #90
     *Instrument: Space Voice  bank #0 preset #91
     *Instrument: Bowed Glass  bank #0 preset #92
     *Instrument: Metal Pad    bank #0 preset #93
     *Instrument: Halo Pad     bank #0 preset #94
     *Instrument: Sweep Pad    bank #0 preset #95
     *Instrument: Ice Rain     bank #0 preset #96
     *Instrument: Soundtrack   bank #0 preset #97
     *Instrument: Crystal      bank #0 preset #98
     *Instrument: Atmosphere   bank #0 preset #99
     *Instrument: Brightness   bank #0 preset #100
     *Instrument: Goblin       bank #0 preset #101
     *Instrument: Echo Drops   bank #0 preset #102
     *Instrument: Star Theme   bank #0 preset #103
     ...
     *Instrument: Bagpipe      bank #0 preset #109
     ...
     *Instrument: Taiko        bank #0 preset #116
     *Instrument: Melo. Tom 1  bank #0 preset #117
     *Instrument: Synth Drum   bank #0 preset #118
     *Instrument: Reverse Cym. bank #0 preset #119
     *Instrument: Gt.FretNoise bank #0 preset #120
     *Instrument: Breath Noise bank #0 preset #121
     *Instrument: Seashore     bank #0 preset #122
     *Instrument: Bird         bank #0 preset #123
     *Instrument: Telephone 1  bank #0 preset #124
     ...
     *Instrument: Fr.Horn 2    bank #128 preset #60
     *Instrument: Square       bank #128 preset #80
     *Instrument: Saw          bank #128 preset #81
     *Instrument: Syn Mallet   bank #128 preset #98
     *Instrument: Echo Bell    bank #128 preset #102
     *Instrument: Sitar 2      bank #128 preset #104
     *Instrument: Gt.Cut Noise bank #128 preset #120
     *Instrument: Fl.Key Click bank #128 preset #121
     *Instrument: Rain         bank #128 preset #122
     *Instrument: Dog          bank #128 preset #123
     *Instrument: Telephone 2  bank #128 preset #124
     *Instrument: Car-Engine   bank #128 preset #125
     *Instrument: Laughing     bank #128 preset #126
     ...
     *Instrument: Thunder      bank #256 preset #122
     *Instrument: Horse-Gallop bank #256 preset #123
     *Instrument: DoorCreaking bank #256 preset #124
     *Instrument: Car-Stop     bank #256 preset #125
     *Instrument: Screaming    bank #256 preset #126
     *Instrument: Lasergun     bank #256 preset #127
     *Instrument: Wind         bank #384 preset #122
     *Instrument: Bird 2       bank #384 preset #123
     *Instrument: Door         bank #384 preset #124
     *Instrument: Car-Pass     bank #384 preset #125
     *Instrument: Punch        bank #384 preset #126
     *Instrument: Explosion    bank #384 preset #127
     *Instrument: Stream       bank #512 preset #122
     *Instrument: Scratch      bank #512 preset #124
     *Instrument: Car-Crash    bank #512 preset #125
     *Instrument: Heart Beat   bank #512 preset #126
     *Instrument: Bubble       bank #640 preset #122
     *Instrument: Wind Chimes  bank #640 preset #124
     *Instrument: Siren        bank #640 preset #125
     *Instrument: Footsteps    bank #640 preset #126
     *Instrument: Train        bank #768 preset #125
     *Instrument: Jetplane     bank #896 preset #125
     *Instrument: Piano 1      bank #1024 preset #0
     *Instrument: Piano 2      bank #1024 preset #1
     *Instrument: Piano 3      bank #1024 preset #2
     *Instrument: Honky-tonk   bank #1024 preset #3
     *Instrument: Detuned EP 1 bank #1024 preset #4
     *Instrument: Detuned EP 2 bank #1024 preset #5
     *Instrument: Coupled Hps. bank #1024 preset #6
     *Instrument: Vibraphone   bank #1024 preset #11
     *Instrument: Marimba      bank #1024 preset #12
     *Instrument: Church Bell  bank #1024 preset #14
     *Instrument: Detuned Or.1 bank #1024 preset #16
     *Instrument: Detuned Or.2 bank #1024 preset #17
     *Instrument: Church Org.2 bank #1024 preset #19
     *Instrument: Accordion It bank #1024 preset #21
     *Instrument: Ukulele      bank #1024 preset #24
     *Instrument: 12-str.Gt    bank #1024 preset #25
     *Instrument: Hawaiian Gt. bank #1024 preset #26
     *Instrument: Chorus Gt.   bank #1024 preset #27
     *Instrument: Funk Gt.     bank #1024 preset #28
     *Instrument: Feedback Gt. bank #1024 preset #30
     *Instrument: Gt. Feedback bank #1024 preset #31
     *Instrument: Synth Bass 3 bank #1024 preset #38
     *Instrument: Synth Bass 4 bank #1024 preset #39
     *Instrument: Slow Violin  bank #1024 preset #40
     *Instrument: Orchestra    bank #1024 preset #48
     *Instrument: Syn.Strings3 bank #1024 preset #50
     *Instrument: Brass 2      bank #1024 preset #61
     *Instrument: Synth Brass3 bank #1024 preset #62
     *Instrument: Synth Brass4 bank #1024 preset #63
     *Instrument: Sine Wave    bank #1024 preset #80
     *Instrument: Doctor Solo  bank #1024 preset #81
     *Instrument: Taisho Koto  bank #1024 preset #107
     *Instrument: Castanets    bank #1024 preset #115
     *Instrument: Concert BD   bank #1024 preset #116
     *Instrument: Melo. Tom 2  bank #1024 preset #117
     *Instrument: 808 Tom      bank #1024 preset #118
     *Instrument: Starship     bank #1024 preset #125
     *Instrument: Carillon     bank #1152 preset #14
     *Instrument: Elec Perc.   bank #1152 preset #118
     *Instrument: Burst Noise  bank #1152 preset #125
     *Instrument: Piano 1d     bank #2048 preset #0
     *Instrument: E.Piano 1v   bank #2048 preset #4
     *Instrument: E.Piano 2v   bank #2048 preset #5
     *Instrument: Harpsichord  bank #2048 preset #6
     *Instrument: 60's Organ 1 bank #2048 preset #16
     *Instrument: Church Org.3 bank #2048 preset #19
     *Instrument: Nylon Gt.o   bank #2048 preset #24
     *Instrument: Mandolin     bank #2048 preset #25
     *Instrument: Funk Gt.2    bank #2048 preset #28
     *Instrument: Rubber Bass  bank #2048 preset #39
     *Instrument: AnalogBrass1 bank #2048 preset #62
     *Instrument: AnalogBrass2 bank #2048 preset #63
     *Instrument: 60's E.Piano bank #3072 preset #4
     *Instrument: Harpsi.o     bank #3072 preset #6
     *Instrument: Organ 4      bank #4096 preset #16
     *Instrument: Organ 5      bank #4096 preset #17
     *Instrument: Nylon Gt.2   bank #4096 preset #24
    ...
    //<editor-fold defaultstate="collapsed" desc="Funciones auxiliares para interfaz gráfica »">
    public static Object[] TablaInstrumentos_Obtener1(int Indice) throws MidiUnavailableException {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
    ...
    public static Object[][] TablaInstrumentos() throws MidiUnavailableException {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        Instrument[] orchestra = MidiSystem.getSynthesizer().getAvailableInstruments();
    ...
    public static String TablaInstrumentosEspañol() throws MidiUnavailableException {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        Instrument[] orchestra = MidiSystem.getSynthesizer().getAvailableInstruments();
        String retorno = "";
        for (int i = 0; i < orchestra.length; i++) {
            String renglón = orchestra[i].toString();
    ...
    public static String TablaInstrumentosOriginal() throws MidiUnavailableException {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        Instrument[] orchestra = MidiSystem.getSynthesizer().getAvailableInstruments();
        String retorno = "";
        for (int i = 0; i < orchestra.length; i++) {
    ...
    private void GenerarCódigoParaLaConversiónDeLLaveAInstrumento() {//<editor-fold defaultstate="collapsed" desc="Código para generar Código »">
        String Instrumentos
                = //<editor-fold defaultstate="collapsed" desc="Listado de instrumentos">
                "INDICE_PIANO_1 = 0,\n"
                + "                INDICE_PIANO_2 = 1,\n"
                + "                INDICE_PIANO_3 = 2,\n"
                + "                INDICE_HONKY_TONK = 3,\n"
    ...
    private void GenerarCódigoParaLaConversiónDeInstrumentoALLave() {//<editor-fold defaultstate="collapsed" desc="Código para generar Código »">
        String Instrumentos
                = //<editor-fold defaultstate="collapsed" desc="Listado de instrumentos">
                "INDICE_PIANO_1 = 0,\n"
                + "                INDICE_PIANO_2 = 1,\n"
    ...
    private void GenerarCódigoParaConstantesDeInstrumentos() throws MidiUnavailableException {//<editor-fold defaultstate="collapsed" desc="Código para generar Código »">
...
//</editor-fold>
    ...
    class Probar {//<editor-fold defaultstate="collapsed" desc="Cuerpo de la biblioteca »">

        void Piratas() {//<editor-fold defaultstate="collapsed" desc="Implementación de la tablatura ꙮ">
            int octava = 5;
        ...
        void CanCan_Garlop_Infernal() {//<editor-fold defaultstate="collapsed" desc="Implementación de la tablatura ꙮ">
            int octava = 4;
        ...
        void Lillium() {//<editor-fold defaultstate="collapsed" desc="Implementación de la tablatura ꙮ">
            int octava = 5;
            Reproducir(octava + "FA#", 500, -1);
            Reproducir((octava + 1) + "DO#", 500, -1);
        ...
        void BrillaBrillaEstrellita() {//<editor-fold defaultstate="collapsed" desc="Implementación de la tablatura ꙮ">
            int octava = 5;
            Reproducir(octava + "DO", 500, -1);
            Reproducir(octava + "DO", 500, -1);
            Reproducir(octava + "SOL", 500, -1);
        ...
        void ChavoDel8() {//<editor-fold defaultstate="collapsed" desc="Implementación de la tablatura ꙮ">
            int octava = 5;
        ...
        void MarioBrossFinal() {//<editor-fold defaultstate="collapsed" desc="Implementación de la tablatura ꙮ">
            int octava = 4;
            Reproducir(octava + "SOL", 400, -1);
            Reproducir(octava + "FA#", 400, -1);
            Reproducir(octava + "SOL", 400, -1);
        ...
        void AdornemosEstaNavidad() {//<editor-fold defaultstate="collapsed" desc="Implementación de la tablatura ꙮ">
            int octava = 5;
            Reproducir((octava + 1) + "DO", 1100, -1);
            Reproducir(octava + "LA#", 500, -1);
            Reproducir(octava + "LA", 500, -1);
        ...
        void LaMañana() {//<editor-fold defaultstate="collapsed" desc="Implementación de la tablatura ꙮ">
            int octava = 5;
            BloqueDeCódigo.Simple p0 = () -> {
                Reproducir(octava + "LA", 600, -1);
                Reproducir(octava + "SOL", 600, -1);
            };
            BloqueDeCódigo.Simple p3 = () -> {
                Reproducir(octava + "MI", 500, -1);
                Reproducir(octava + "RE", 500, -1);
                Reproducir(octava + "DO", 500, -1);
            };
            BloqueDeCódigo.Simple p1 = () -> {
                Reproducir(octava + "SOL", 500, -1);
                p3.Ejecutar();
                Reproducir(octava + "RE", 500, -1);
                Reproducir(octava + "MI", 500, -1);
            };
            BloqueDeCódigo.Simple p2 = () -> {
            ...
            BloqueDeCódigo.Simple p4 = () -> {
                p1.Ejecutar();
                p1.Ejecutar();
                p2.Ejecutar();
            };
            BloqueDeCódigo.Simple p5 = () -> {
                p3.Ejecutar();
                p1.Ejecutar();
                p1.Ejecutar();
                p2.Ejecutar();
        ...
        void ElPuenteDeLondres() {//<editor-fold defaultstate="collapsed" desc="Implementación de la tablatura ꙮ">
            int octava = 5;
            Reproducir((octava + 1) + "RE", 1100, -1);
            Reproducir((octava + 1) + "MI", 500, -1);
            Reproducir((octava + 1) + "RE", 500, -1);
        ...
        void CanciónDeCuna_Lullaby() {//<editor-fold defaultstate="collapsed" desc="Implementación de la tablatura ꙮ">
            int octava = 5;
            Reproducir(octava + "FA#", 500, -1);
            Reproducir(octava + "FA#", 500, -1);
            Reproducir(octava + "LA", 1100, -1);
        ...
        void Tapión() {//<editor-fold defaultstate="collapsed" desc=" Implementación de la tablatura ꙮ ">
            int octava = 5;
            BloqueDeCódigo.Simple p1 = () -> {
            ...
            BloqueDeCódigo.Simple p6 = () -> {
                p4.Ejecutar();
                p5.Ejecutar();
            };
            BloqueDeCódigo.Simple p7 = () -> {
                Reproducir((octava + 1) + "DO", 500, -1);
                Reproducir(octava + "SI", 500, -1);
                Reproducir(octava + "LA", 500, -1);
                Reproducir(octava + "SOL", 500, -1);
            ...
            BloqueDeCódigo.Simple p10 = () -> {
                p3.Ejecutar();
                p6.Ejecutar();
            };
            BloqueDeCódigo.Simple p11 = () -> {
                p3.Ejecutar();
                p8.Ejecutar();
            };
            for (int i = 1; i <= 3; i++) {
        ...
        void ParaElisa() {//<editor-fold defaultstate="collapsed" desc="Implementación de la tablatura ꙮ ">
            int octava = 3;
            BloqueDeCódigo.Simple p1 = () -> {
                Reproducir((octava + 1) + "MI", 500, -1);
                Reproducir((octava + 1) + "RE#", 500, -1);
    ...
    public interface Constantes {//<editor-fold defaultstate="collapsed" desc="Cuerpo de la biblioteca »">

        public final static int INSTRUMENTOS_SOPORTADOS = 225;

        //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
        /**
         * Es un valor entero que sirve de llave para identificar un instrumento
         * y en sus bits contiene la información del banco y del programa
         * específico para el instrumento. en sus primeros 16 bits almacena el
         * banco, y en los ultimos 16 bits almacena el programa, aplicando
         * bit-wise se puede recuperar la información de cada uno de los
         * canales, sirve para hacer referencia más rapídamente a un instrumento
         * desde código usando la función de
         * {@linkplain ReproductorNotas#CambiarInstrumento(int)  Cambiar de instrumento usando llave}
         * sin necesidad de tener que ir a la tabla de instrumentos y consultar
         * el banco y el programa del instrumento.
         */
        //</editor-fold>
        public final static int //<editor-fold defaultstate="collapsed" desc="Definición de llaves">
                PIANO_1 = 0,
                PIANO_2 = 1,
                PIANO_3 = 2,
                HONKY_TONK = 3,
        ...
        public final static int //<editor-fold defaultstate="collapsed" desc="Definición de instrumentos">
                INDICE_PIANO_1 = 0,
                INDICE_PIANO_2 = 1,
                INDICE_PIANO_3 = 2,
                INDICE_HONKY_TONK = 3,
    ...
    public interface HerramientasMIDI extends Constantes {//<editor-fold defaultstate="collapsed" desc="Cuerpo de la biblioteca »">

        //<editor-fold defaultstate="collapsed" desc="Herramientas para la conversión de notas textuales en byte »">
        //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
        /**
         * Recibe una cadena de texto que representa a una nota con su octava y
         * la convierte a su valor númerico correspondiente en la tabla de notas
         * que pueden ser interpretadas por MIDI.
         * <br><br>
         * Aquí les dejo una tabla que muestra los valores correspondientes para
         * cada nota en cada octava.
         * <br><br>
         * <p align="center">
         * <img src="https://docs.google.com/drawings/d/e/2PACX-1vTKYRQYY5_P6SLsZoIDyUcAm6QqtCRfef26qhgU0jxZTxjG6HW2QKraEfeXysZiGO8XNSZamSHD1oz5/pub?w=450&h=350">
         * </p>
         * <br><br>
         * lo más recomendable es trabajar como máximo hasta la octava 9 para
         * evitar, errores en la estimación del sonido a reproducir.
         * <br><br>
         * Ejemplos:<br>
         * » Si recibe <span style="color: #FF9900;">"7D"</span> retornará el
         * valor de la nota D (RE) en la octava 7 es decir
         * <span style="color: #FF00cc;">86</span><br>
         * » Si recibe <span style="color: #FF9900;">"D"</span> sin especificar
         * la octava, interpretará lo mismo que si hubiera recibido
         * <span style="color: #FF9900;">"0D"</span>, retornará el valor de la
         * nota D (RE) en la octava 0 es decir
         * <span style="color: #FF00cc;">2</span><br>
         */
        //</editor-fold>
        public static int CalcularByte_Nota(String Nota) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
            int Octava = 0;
            int i;
            try {
                i = 2;
        ...
        //<editor-fold defaultstate="collapsed" desc=" JavaDoc [≡] ">
        /**
         * <table style="background-color: #ffcc00; width: 220px;" border="1" cellspacing="0" cellpadding="0" align="center">
         * <tbody>
         * <tr>
         * <td style="background-color: #000000; text-align: center;" colspan="2"><span style="color: #ffffff;"><strong>Nota</strong></span></td>
         * <td style="background-color: #000000; text-align: center;"><span style="color: #ffffff;"><strong>Retorno</strong></span></td>
         * </tr>
         * <tr>
         * <td style="text-align: center; width: 33%;"><strong>C</strong></td>
         * <td style="text-align: center; width: 33%;"><strong>DO</strong></td>
         ...
         * </tr>
         * <tr>
         * <td style="text-align: center; width: 33%;"><strong>D</strong></td><td style="text-align: center; width: 33%;"><strong>RE#</strong></td>
         ...
         * </tr>
         * <tr>
         * <td style="text-align: center; width: 33%;"><strong>E</strong></td><td style="text-align: center; width: 33%;"><strong>MI</strong></td>
         * <td style="background-color: #ffffff; text-align: center;">4</td>
         * </tr>
         * <tr>
         * <td style="text-align: center; width: 33%;"><strong>F</strong></td><td style="text-align: center; width: 33%;"><strong>FA</strong></td>
         ...
         * </tr>
         * <tr>
         * <td style="text-align: center; width: 33%;"><strong>G</strong></td><td style="text-align: center; width: 33%;"><strong>SOL</strong></td>
         ...
         * </tr>
         * <tr>
         * <td style="text-align: center; width: 33%;"><strong>A</strong></td><td style="text-align: center; width: 33%;"><strong>LA</strong></td>
         ...
         * </tr>
         * <tr>
         * <td style="text-align: center; width: 33%;"><strong>B</strong></td>
         * <td style="text-align: center; width: 33%;"><strong>SI</strong></td>
         ...
         */
        //</editor-fold>
        public static int ValorColumnaNota(String nota) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
        ...
        public static String ConvertirNotaString(int nota) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
            int octava = nota / 12;
            int n = nota % 12;
            switch (n) {
                case 0:
        ...
        static String ConvertirInstrumentoAString(int llave) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
            try {
        ...
        static int ObtenerLlave(int Indice) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
            switch (Indice) {
                case INDICE_PIANO_1:
                    return PIANO_1;
                case INDICE_PIANO_2:
        ...
        static int ObtenerIndice(int banco, int programa) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
            return ObtenerIndice(GenerarLlaveInstrumento(banco, programa));
        }//</editor-fold>

        static int ObtenerIndice(int llave) {//<editor-fold defaultstate="collapsed" desc="Implementación de código »">
            switch (llave) {
                case PIANO_1:
