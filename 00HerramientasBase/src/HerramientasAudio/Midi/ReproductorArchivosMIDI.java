...
public final class ReproductorArchivosMIDI {
    ...
    public ReproductorArchivosMIDI() {
        this(null);
    }

    public ReproductorArchivosMIDI(Object o) {
        try {
            Asignar_Midi(o);
        } catch (Exception ex) {
        }
    ...
    public static Sequence Generar_Sequence(Object o) throws Exception {
        ...
        if (o instanceof String) {
            ...
            if (f.exists()) {
                return MidiSystem.getSequence(f);
            } else if (Sistema.Verificar_Existencia_URL(string)) {
    ...
    public ReproductorArchivosMIDI RepetirEnBucle_Indefinidamente() {
        return RepetirEnBucle(-1);
    }

    public ReproductorArchivosMIDI RepetirEnBucle(int númeroDeRepeticiones) {
        InterpretadorMidi.setLoopCount(númeroDeRepeticiones);
        return this;
    }

    public ReproductorArchivosMIDI ModificarUbicación_Porcentaje(float p) {
        if (p > 1) {
    ...
    public ReproductorArchivosMIDI ModificarUbicación_Segundos(float s) {
        ModificarUbicación_Porcentaje(s / ObtenerDuración_Segundos());
        return this;
    }

    public ReproductorArchivosMIDI Reiniciar() {
        InterpretadorMidi.setMicrosecondPosition(0);
        return this;
    }

    public ReproductorArchivosMIDI Pausar() {
    ...
    public ReproductorArchivosMIDI Reproducir() {
        if (!InterpretadorMidi.isRunning()) {
    ...
    public ReproductorArchivosMIDI Cerrar() {
        Pausar();
