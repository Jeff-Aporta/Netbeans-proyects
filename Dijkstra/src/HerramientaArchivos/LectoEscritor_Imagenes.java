...
public class LectoEscritor_Imagenes {
    ...
    public static BufferedImage cargarImagen() {
        ...
        return cargarImagen(selector.getSelectedFile());
    }

    public static BufferedImage cargarImagen(URL archivo) {
    ...
    public static BufferedImage ConvImgARGB(BufferedImage imagen) {
        if (imagen == null || imagen.getType() == 2) {
            return imagen;
        }
    ...
    public static void ExportarImagen(BufferedImage imagen, File Archivo) {
        ExportarImagen(imagen, Archivo, false);
    }
    ...
    public static void ExportarImagen(BufferedImage imagen, String ruta) {
        ExportarImagen(imagen, ruta, false);
    }
