...
public class Filtros_Lineales {
    ...
    public static PropiedadAjuste Ajuste_Rellenar(BufferedImage ImagenRelleno, BufferedImage ImagenÁrea, byte AlinH, byte AlinV, boolean ConservarPixeles) {
    ...
    public static PropiedadAjuste Ajuste_Ajustar(BufferedImage ImagenRelleno, BufferedImage ImagenÁrea, byte AlinH, byte AlinV) {
        return Ajuste_Ajustar(ImagenRelleno, ImagenÁrea, AlinH, AlinV, false);
    }

    public static PropiedadAjuste Ajuste_Ajustar(BufferedImage ImagenRelleno, BufferedImage ImagenÁrea, byte AlinH, byte AlinV, boolean ConservarPixeles) {
        if (ImagenRelleno == null || ImagenÁrea == null) {
            return null;
        } else if (new Dupla(ImagenRelleno).esIgual(ImagenÁrea)) {
            return Ajuste_Ninguno(ImagenRelleno, ImagenÁrea);
    ...
    public static PropiedadAjuste Ajuste_Alinear(BufferedImage ImagenRelleno, BufferedImage ImagenÁrea, byte Al_H, byte Al_V) {
        if (ImagenRelleno == null || ImagenÁrea == null) {
            return null;
        }
    ...
    public static PropiedadAjuste Ajuste_Centrado(BufferedImage ImagenRelleno, BufferedImage ImagenÁrea, byte AH, byte AV) {
        if (ImagenRelleno == null || ImagenÁrea == null) {
            return null;
        }
    ...
    public static PropiedadAjuste Ajuste_Centrado_Ajustar(BufferedImage ImagenRelleno, BufferedImage ImagenÁrea, boolean ConservarPixeles) {
        return Ajuste_Centrado_Ajustar(ImagenRelleno, ImagenÁrea, Dupla.MEDIO, Dupla.MEDIO, ConservarPixeles);
    }

    public static PropiedadAjuste Ajuste_Centrado_Ajustar(BufferedImage ImagenRelleno, BufferedImage ImagenÁrea, byte AH, byte AV) {
        return Ajuste_Centrado_Ajustar(ImagenRelleno, ImagenÁrea, AH, AV, false);
    }

    public static PropiedadAjuste Ajuste_Centrado_Ajustar(BufferedImage ImagenRelleno, BufferedImage ImagenÁrea, byte AH, byte AV, boolean ConservarPixeles) {
        if (ImagenRelleno == null || ImagenÁrea == null) {
            return null;
        }
    ...
    public static BufferedImage Escalar(BufferedImage imagen, double porcentaje) {
    ...
    public static BufferedImage Escalar(BufferedImage Imagen, double pX, double pY) {
