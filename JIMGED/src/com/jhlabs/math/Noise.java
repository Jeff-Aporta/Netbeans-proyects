        ...
        new JFrame("Perlin Noise") {
...

            {
                ...
                new Thread() {
                    ...
                    public void run() {
                        while (true) {
                            BufferedImage imagen = new BufferedImage(getWidth(), getHeight(), 2) {
                                {
                                    ...
                                    for (int y = 0; y < getHeight(); y++) {
                                        ...
                                        for (int x = 0; x < getWidth(); x++) {
                                            float perlin = turbulence3(xoff, yoff, zoff, 4);
//                                            perlin = ((perlin + 1) / 2);
                                            if (perlin < 0) {
...
//                                                perlin = 1;
//                                            }
                                            setRGB(x, y, new Color(perlin, perlin, perlin).getRGB());
                                            xoff += 0.005;
                                        }
                                        yoff += 0.005;
                                    }
