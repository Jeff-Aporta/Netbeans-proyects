...
public class Rhythm implements PatternProducer {
    ...
    /**
     * Adds a layer to this Rhythm, but fails silently if the rhythm already has
     * MAX_LAYERS layers.
     *
     * @param layer
     * @return
    ...
    /**
     * Returns all layers that have been added with the traditional addLayer()
     * method - but to truly find out what the layer will sound like at a given
     * segment, use getLayersForSegment(), which takes alt layers into account.
     *
    ...
    /**
     * Returns true if the number of layers is less than MAX_LAYERS, which is
     * limited to 16 by the MIDI Specification
     *
     * @return
     */
    ...
    /**
     * Returns all AltLayers for the given layer; the resulting list is unsorted
     * by z-order
     *
    ...
    /**
     * Returns all AltLayers for the given layer sorted by each AltLayer's
     * z-order
     */
    ...
    /**
     * Sets an alt layer that will recur every recurrence times *after* the
     * start index is reached. If the start index is 2 and the recurrence is 5,
     * this alt layer will be used every time the segment % recurrence == start.
     * By default, this has a Z-Order of 1.
     */
    ...
    /**
     * Sets an alt layer that will play between and including the start and end
     * indices. By default, this has a Z-Order of 2.
     */
    ...
    /**
     * Sets an alt layer that will play one time, at the given segment. By
     * default, this has a Z-Order of 3.
     */
    ...
    /**
     * Gives a RhythmAltLayerProvider, which will make its own determination
     * about what type of alt layer to play, and when to play it. By default,
     * this has a Z-Order of 4.
     *
    ...
    /**
     * Gives a RhythmAltLayerProvider, which will make its own determination
     * about what type of alt layer to play, and when to play it.
     *
     * @see RhythmAltLayerProvider
     */
    ...
    /**
     * Combines rhythms into multiple layers. If there are more than MAX_LAYERS
     * layers in the provided rhythms, only the first MAX_LAYERS are used (for
     * example, if you pass five rhythms that each have four layers, the
     * combined rhythm will only contain the layers from the first four
     * rhythms). This method also ensures that the Rhythm Kit for each of the
     ...
     * pattern is repeated. For example, creating a layer of "S...S...S...O..."
     * and a length of 3 would result in a Rhythm pattern of
     * "S...S...S...O...S...S...S...O...S...S...S...O..."
     */
    ...
    /**
     * Uses the RhythmKit to translate the given rhythm into a Staccato music
     * string.
     *
     * @see getPattern
     */
    ...
    /**
     * Returns the full rhythm, including alt layers, but not translated into
     * Staccato music strings by looking up rhythm entries into the RhythmKit
     *
     * @return
     */
    ...
    class AltLayer {
        ...
        /**
         * Indicates whether this alt layer should be provided for the given
         * segment
         */
        public boolean shouldProvideAltLayer(int segment) {
            ...
            if ((segment >= startIndex) && (segment <= endIndex)) {
                ...
                if ((recurrence != -1) && (segment % (recurrence) == startIndex)) {
                    return true;
                }
            }
